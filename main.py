...
def gather_test_data():
    request_list = {'http://archive.org/wayback/available?url=bbc.co.uk/news&timestamp=20091114045636',
                    'http://archive.org/wayback/available?url=economist.com/&timestamp=20091114045636',
                    'http://archive.org/wayback/available?url=guardian.co.uk/&timestamp=20150925135747',
    ...
    for req in request_list:
        print (req)
    # r_bbc = requests.get('http://archive.org/wayback/available?url=bbc.co.uk/news&timestamp=20091114045636')
    # r_econ = requests.get('http://archive.org/wayback/available?url=economist.co.uk/&timestamp=20091114045636')
    # r_guardian = requests.get('http://archive.org/wayback/available?url=guardian.co.uk/&timestamp=20150925135747')
    # r_nyt = requests.get('http://archive.org/wayback/available?url=nytimes.com/&timestamp=20150925135747')
    # r_indep = requests.get('http://archive.org/wayback/available?url=independent.co.uk/&timestamp=20150925135747')
    data = r.json()
